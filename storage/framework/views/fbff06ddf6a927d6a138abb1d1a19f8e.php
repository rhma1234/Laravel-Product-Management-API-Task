...
<head>
    <meta charset="UTF-8">
    <title><?php echo e(__('messages.add_new_product')); ?></title>
...
<div class="container mt-5">
    <h1 class="mb-4"><?php echo e(__('messages.add_new_product')); ?></h1>
    ...
    <form action="<?php echo e(route('products.store')); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="name[ar]" id="name_ar" class="form-control" value="<?php echo e(old('name.ar')); ?>">
        </div>

        <!-- الاسم بالإنجليزي -->
        <div class="mb-3">
            <label for="name_en" class="form-label"><?php echo e(__('messages.name_en')); ?></label>
            <input type="text" name="name[en]" id="name_en" class="form-control" value="<?php echo e(old('name.en')); ?>">
        </div>

        <!-- الوصف بالعربي -->
        <div class="mb-3">
            <label for="description_ar" class="form-label"><?php echo e(__('messages.description_ar')); ?></label>
            <textarea name="description[ar]" id="description_ar" class="form-control" rows="3"><?php echo e(old('description.ar')); ?></textarea>
        </div>

        <!-- الوصف بالإنجليزي -->
        <div class="mb-3">
            <label for="description_en" class="form-label"><?php echo e(__('messages.description_en')); ?></label>
            <textarea name="description[en]" id="description_en" class="form-control" rows="3"><?php echo e(old('description.en')); ?></textarea>
        </div>
        ...
        <div class="mb-3">
            ...
            <select name="currency" class="form-select select2">
                ...
                <?php $__currentLoopData = \App\Enums\CurrencyEnum::cases(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($currency->value); ?>" <?php echo e(old('currency') == $currency->value ? 'selected' : ''); ?>>
        ...
        <div class="mb-3">
            ...
            <select name="tag_ids[]" id="tag_ids" class="form-select select2" multiple>
                <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($tag->id); ?>" <?php echo e(in_array($tag->id, old('tag_ids', [])) ? 'selected' : ''); ?>>
                        <?php echo e($tag->name); ?>
        ...
        <!-- صور المنتج -->
        <div class="mb-3">
            <label for="images" class="form-label"><?php echo e(__('messages.image')); ?></label>
            <input type="file" name="images[]" id="images" class="form-control" multiple>
        </div>

        <button type="submit" class="btn btn-primary"><?php echo e(__('messages.submit_create')); ?></button>
    </form>
</div>
...
<script>
    $(document).ready(function() {
        $('.select2').select2({
            placeholder: "<?php echo e(__('messages.select_placeholder')); ?>",
            width: '100%',
...
<?php /**PATH C:\laragon\www\task\resources\views/products/create.blade.php ENDPATH**/ ?>